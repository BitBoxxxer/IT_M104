...
### Распространяется по лицензиям. См. [`LICENSE.txt`](https://github.com/BitBoxxxer) для получения дополнительной информации.
...
>
>> Лицензии ПОКА нет - Если кратко - код проекта принадлежит автору проекта - ниже есть контакты владельца кода.
